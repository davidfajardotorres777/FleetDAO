...
Para iniciar el servidor backend que procesa las peticiones y el modelo de IA:
```bash
...
En otra terminal, ejecuta la interfaz gráfica interactiva para visualizar las geocercas y la telemetría en tiempo real:
```bash
